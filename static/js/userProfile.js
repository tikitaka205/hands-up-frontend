    ...
    $.ajax({
        ...
        error : function(error){
            ...
            <div class="text-center">
                <span style="font-size:25px; color:black;">회원님의 경매는 이게 전부에요 &#128517;</span>
                <button class="btn btn-primary m-3" onclick="window.location.href='/goods/goodsPost.html'">경매 더 올리기</button>
            </div>
            `
            $('#endList').html(temp)
        }
